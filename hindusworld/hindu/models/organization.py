...
class Organization(models.Model):
    ...
    status = models.CharField(max_length=200, choices=[(e.name, e.value) for e in status], default=status.PENDING.value)
    geo_site = models.CharField(max_length=200, choices=[(e.name, e.value) for e in GeoSite], default=GeoSite.DISTRICT.value)
